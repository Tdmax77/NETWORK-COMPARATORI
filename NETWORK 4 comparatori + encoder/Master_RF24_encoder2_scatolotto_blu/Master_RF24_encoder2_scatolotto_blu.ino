...
RF24 radio(10/*CE*/, 9/*CSN*/);             // Coto and Kren (7,8)  RF-NANO with ext ant. (9,10) RF-NANO without ext ant (10,9)
...
const int N_rec (4);      // define number of slaves (receiver = 4 COMP + 1 ENCODER)
