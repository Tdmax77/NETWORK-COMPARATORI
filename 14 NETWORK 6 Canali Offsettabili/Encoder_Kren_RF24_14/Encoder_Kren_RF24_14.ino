...
void setup() {
  ...
  radio.printDetails();
  network.begin(/*channel*/ 110, /*node address*/ this_node); // 80 orange 85 blue 90 black    <<<<<<<<<<<<<<<<< -- SET THIS VALUE DEPENDING OF WHICH CHANNEL YOU ARE USING
  // setting per network *****************************************
...
Serial.print(" questo è il valore di pl.VO");
Serial.println(pl.VO);
